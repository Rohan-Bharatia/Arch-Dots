...
route_selection() {
    ...
    case "$choice" in
        ...
        *configs*)
            ...
            ;;
        *power*)
            run_app rofi -show power-menu -modi "power-menu:$SCRIPTS_DIR/rofi/powermenu.sh"
            ;;
        *)
            exit 0
            ;;
...
show_ai_menu() {
    ...
    case "${choice,,}" in
        ...
        *kokoro*cpu*)
            ...
            ;;
        *whisper*)
            run_app "$SCRIPTS_DIR/tts_stt/faster_whisper/faster_whisper_sst.sh"
            ;;
        *parakeet*)
...
show_visuals_menu() {
    ...
    case "${choice,,}" in
        *cycle*)
            run_app "$SCRIPTS_DIR/theme_matugen/random_theme.sh"
            ;;
        *matugen*config*)
            run_app "$SCRIPTS_DIR/theme_matugen/matugen_config.sh"
            ;;
        *rofi*wallpaper*)
        ...
        *wallpaper*app*)
            ...
            ;;
        *animation*)
            run_app rofi -show animations -modi "animations:$SCRIPTS_DIR/rofi/hypr_anim.sh"
            ;;
        *shader*)
...
show_networking_menu() {
    ...
    case "${choice,,}" in
        *warp*)
            ...
            ;;
        *ssh*)
            run_term_hold "wifi_testing" sudo "$SCRIPTS_DIR/networking/openssh_setup.sh"
            ;;
        *)
            show_main_menu
            ;;

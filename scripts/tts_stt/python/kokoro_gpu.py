...
MODEL_PATH = os.path.expanduser("~/.uv/kokoro_gpu/kokoro-v1.0.fp16-gpu.onnx")
VOICES_PATH = os.path.expanduser("~/.uv/kokoro_gpu/voices-v1.0.bin")
VOICE_NAME = "af_heart"
LANG_CODE = "en-us"
...
def setup_signal_handlers() -> None:
    handler = lambda sig, frame: os._exit(0)
